...
for ((index = 11000; index <= 11000; index += 10))
do
    echo $index
    sed -ie ''69,70s/value/$index/g'' $dla_finder/desi_mock_iron1.py
    srun -n 1 -c 256 python $dla_finder/desi_mock_iron1.py
    sed -ie ''69,70s/$index/value/g'' $dla_finder/desi_mock_iron1.py
done