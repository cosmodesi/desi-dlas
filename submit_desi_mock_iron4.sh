...
for ((index = 9260; index <= 9500; index += 10))
#460 470 480 490 500 510 520 530 540 550 560 570 580 590 600
do
    echo $index
    sed -ie ''69,70s/value/$index/g'' $dla_finder/desi_mock_iron4.py
    srun -n 1 -c 256 python $dla_finder/desi_mock_iron4.py
    sed -ie ''69,70s/$index/value/g'' $dla_finder/desi_mock_iron4.py
done

for ((index = 13000; index <= 14000; index += 10))
#460 470 480 490 500 510 520 530 540 550 560 570 580 590 600
do
    echo $index
    sed -ie ''69,70s/value/$index/g'' $dla_finder/desi_mock_iron4.py
