...
class DesiMock: 
    ...
    def get_sightline(self, id, camera = 'all', rebin=False, normalize=False):
        ...
        if camera == 'all':
            ...
            rzgbound = self.split_point_rz + np.argmin(abs(self.wavelength[self.split_point_rz:] - self.wavelength[self.split_point_rz - 1]))+1 #+1 for mock
